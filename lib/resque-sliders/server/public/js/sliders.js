$(document).ready(function() {
  ...
  $('.deleter').each(function() {
    var deleter = $(this);
    var id = deleter.attr("id");
    var part1 = id.substring(0, id.lastIndexOf("-"));
    var host = part1.substring(0, part1.lastIndexOf("-"));
    var queue = part1.substring(part1.lastIndexOf("-")+1);
    deleter.click(function() {
      $.post(host, { queue: queue, delete: true }, function(data) {
        // reload window
        window.location.reload(true);
      });
    });
